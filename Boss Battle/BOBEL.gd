...
func _input(event):
	if event.is_action_pressed("game_usage") and len(get_overlapping_child_tree()) > 1:
...
func _physics_process(_delta):
	if target == 0 and path.size() == 0:
		path = [Vector(-4400,-3500),Vector(-27,12.458,-5),Vector(-23,12.458,-1),Vector(-20.582,12.458,-5.879)]
	if path.size() > 0:
